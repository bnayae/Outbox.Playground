...
public interface ICloudEventBuilder
{
    ...
    /// <param name="dataRef">The dataRef payload to include in the event</param>
    /// <returns>A new CloudEvent instance</returns>
    Task<CloudEvent> BuildAsync<TId, TData>(TId id, TData dataRef);

    /// <summary>
    /// Builds a CloudEvent with a dataRef reference (claim check pattern) and auto-generated ID.
    /// </summary>
    /// <param name="data">The reference URL to the external dataRef location</param>
